...
function mostrarCartelGanador(){ 
  if(chequearSiGano(true)){
    alert("Felicidades!! Lograste armar el Rompecabezas");
  } 
}
...
function intercambiarPosiciones(fila1, columna1, fila2, columna2){
  ...
  var elementoPieza1 = document.getElementById('p'+pieza1);
  var elementoPieza2 = document.getElementById('p'+pieza2);
